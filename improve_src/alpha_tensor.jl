...
const T = let matric = zeros(3,3,3,3)
    matric[1,1,1,1] = 1;      matric[3,3,3,3] = 1
    matric[1,2,1,2] = 1/2;    matric[1,2,2,3] = 1/2
    matric[1,3,1,3] = 1/6;    matric[1,3,2,2] = 2/3;    matric[1,3,3,1] = 1/6
    matric[2,1,2,1] = 1/2;    matric[2,1,3,2] = 1/2
    matric[2,2,1,3] = 1/6;    matric[2,2,2,2] = 2/3;    matric[2,2,3,1] = 1/6
    matric[2,3,1,2] = 1/2;    matric[2,3,2,3] = 1/2
    matric[3,1,1,3] = 1/6;    matric[3,1,2,2] = 2/3;    matric[3,1,3,1] = 1/6
    matric[3,2,2,1] = 1/2;    matric[3,2,3,2] = 1/2
